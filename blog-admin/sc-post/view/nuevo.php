        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side strech">                
                ...
                <section class="content">
                    <div class="container">
                        <form id="frm-post" name="frm-post" action="../control/post.publicar.php" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="group" id="" value="<?=$_SESSION['not']['group']?>" >
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="col-sm-12">
                                    <input type="text" class="form-control in-titulo" name="titulo" required placeholder="Titulo" onblur="createURL(this);" onkeyup="createURL(this);">
                                    <input type="hidden" name="friendly" id="friendly">
                                    <label class="tx-friendly"><b>URL Friendly:</b> <span id="txt-titulo">esta-es-una-url-amigable</span></label>
                                </div>
                                <div class="col-sm-12">
                                    <textarea class="ckeditor" id="editorPost" name="post" style="width:500px;"></textarea>
                                    <div id="#msgBox"></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="col-sm-12 group-panel">
                                                ...
                                                <li>
                                                    <label>
                                                        ...
                                                        <div style="margin-top:10px;">
                                                            <div class="col-xs-7">                                                        
                                                                <input id="datepicker" name="fecha" type="text" type="text" class="form-control" value="<?=date("Y-m-d")?>" placeholder="<?=date("Y-m-d")?>">                                                                
                                                            </div>
                                                            <div class="col-xs-5">
                                                                <div class="bootstrap-timepicker pull-right">
                                                                    <input id="timepicker3" name="hora" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </label>
                                    ...
                                    <div class="box box-primary box-list collapsed-box">
                                        ...
                                        <div class="box-body" style="display: none;">
                                            <img id="imgPortada" src="img/avatar.png" class="img-thumbnail" style="width:100%; display:none;" />
                                            ...
                                            <input type="text" name="pst_imagen_alt" class="form-control">
                                        </div><!-- /.box-body -->
                                    </div><!-- /.box -->
                                        ...
                                        <div class="box-body" style="display: none;">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <input type="text" name="pst_img_url" class="form-control" placeholder="https://">
                                                </div>
                                            </div>
                                        </div><!-- /.box-body -->
                                    </div><!-- /.box -->
                                        ...
                                        <div class="box-body" style="display: none;">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <input type="text" name="yt-url-video" class="form-control" placeholder="https://www.youtube.com/watch?v=nCkpzqqog4k">
                                                </div>
                                                <!-- <div class="col-xs-4">
                                                    <label>Ancho:</label>
                                                    <input type="text" name="yt-ancho" class="form-control" placeholder="100 px/%">
                                                </div>
                                                <div class="col-xs-4">
                                                    <label>Alto:</label>
                                                    <input type="text" name="yt-alto" class="form-control" placeholder="100 px/%">
                                                </div>
                                                <div class="col-xs-4">
                                    ...
                                    <div class="box box-primary box-list collapsed-box">
                                        ...
                                        <div class="box-body" style="display: none;">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <textarea name="video-otro" class="form-control" placeholder="Pegar iframe del video."></textarea>
                                                </div>
                                                <div class="col-xs-12">
                                    ...
                                    <div class="box box-primary box-list collapsed-box">
                                        ...
                                        <div class="box-body" style="display: none;">
                                            <ul class="ul-rad">
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="st-socialmedia" checked="" value="1">
                                                        <span>Permitir social media</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="stcomentarios" checked="" value="1">
                                                        <span>Permitir comentarios</span>
                                                    </label>
                                                </li>
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="st-autor" checked="" value="1">
                            ...
                            <div class="col-sm-8">
                                <div class="col-sm-12 marging-top">
                                    ...
                                    <!-- <span onclick="savePost();" class="btn btn-primary btn-sm btn-flat pull-right">Guardar y Publicar</span> -->
                                    <!-- <span onclick="savePost();" class="btn btn-primary btn-sm btn-flat pull-right">Guardar y Publicar</span> -->
