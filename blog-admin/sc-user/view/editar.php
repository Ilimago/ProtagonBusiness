                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                        ...
                                        <!--<small class="dEmpresa">Lola Diseños</small>-->
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                    ...
                    <div class="col-sm-10">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-sm-7">
                                        <form id="up_frm_perfil" name="up_frm_perfil">
                                            <input type="hidden" value="2" name="usu_perfil">
                                            <label><?=$GLOBALS[$ln]['user'][22]?></label>
                                            <input type="text" class="form-control" name="usu_nombre" value="<?=$nombre?>">

                                            <br>
                                            <label>Breve Descripción</label>
                                            <textarea name="usr_sexo" class="form-control" rows="4"><?=$descripcion?></textarea>                                
                                            
                                            <br>
                                            <label>Twitter</label>
                                            <input type="text" name="twitter" class="form-control" placeholder="http://" value="<?=$tuister?>"> 

                                            <br>
                                            <label>Facebook</label>
                                            <input type="text" name="facebook" class="form-control" placeholder="http://" value="<?=$face?>">   

                                            <label><?=$GLOBALS[$ln]['user'][4]?></label>
                                            <input type="email" class="form-control" name="usu_mail2" value="<?=$mail?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-7">
                                                    ...
                                                    <input type="password" class="form-control" name="pass-1">

                                                    <label><?=$GLOBALS[$ln]['user'][8]?></label>
                                                    <input type="password" class="form-control" name="pass-2">
                                                    ...
                                                    <select class="form-control" name="usu_perfil">
                                                        ...
                                                        <option value="5">Administracion de Productos</option>
                                                        <option value="6">Administracion de CeDis</option>
                                                        <option value="7">Administracion de Distribuidores</option>
                                                    </select>-->
                                                </div>
                                            ...
                                            <a class="btn btn-primary" href="javascript:update();">
                                                &ensp;&ensp; Actualizar Usuario &ensp;&ensp;
                                            </a>
                                            <a href="index.php" class="btn btn-danger">
                                                &ensp;&ensp; Cancelar &ensp;&ensp;
                                            </a>
                                            <br><br><br>
