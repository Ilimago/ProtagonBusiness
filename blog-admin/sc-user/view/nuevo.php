                    ...
                    <div class="col-sm-10">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-sm-7">
                                        <form id="nw_frm_perfil" name="nw_frm_perfil">
                                            ...
                                            <textarea name="usr_sexo" class="form-control" rows="4"></textarea>                                            
                                            ...
                                            <input type="text" name="facebook" class="form-control" placeholder="http://">   

                                            <br><br>
                                            <label>Usuario (<?=$GLOBALS[$ln]['user'][4]?>)</label>
                                            <input type="email" class="form-control" name="usu_mail">
                                            ...
                                            <a class="btn btn-primary" href="javascript:newRegistro();" id="save-perfil-nw">
                                                &ensp;&ensp; Guardar Usuario &ensp;&ensp;
                                            </a>
